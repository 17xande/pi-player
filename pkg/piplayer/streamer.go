...
func (o *OMXStreamer) Open(filename string, audioOutput string, loop bool, debug bool, player *Player) error {
...
func (o *OMXStreamer) wait(player *Player) error {
...
func (o *OMXStreamer) pipe(message string) error {
...
func (o *OMXStreamer) Pause() error {
...
func (o *OMXStreamer) PlaybackRate(speed int) error {
...
func (o *OMXStreamer) Seek(direction int) error {
	if o.status != statusPlaying && o.status != statusPaused {
...
func (o *OMXStreamer) Chapter(index int) error {
	// TODO: everything
	return nil
}

// Volume sets the video volume.
func (o *OMXStreamer) Volume(vol float64) error {
	// TODO: everything
	return nil
}

// AudioStream sets the specified video audio stream.
func (o *OMXStreamer) AudioStream(index int) error {
	// TODO: everything
	return nil
}

// SubtitleStream sets the subtitle stream.
func (o *OMXStreamer) SubtitleStream(index int) error {
	// TODO: everything
	return nil
}
